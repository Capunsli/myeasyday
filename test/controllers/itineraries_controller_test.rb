...
class ItinerariesControllerTest < ActionController::TestCase
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post :create, itinerary: { bodenstaendige: @itinerary.bodenstaendige, trendsetter: @itinerary.trendsetter, tueftler: @itinerary.tueftler }
    end
  ...
  test "should update itinerary" do
    patch :update, id: @itinerary, itinerary: { bodenstaendige: @itinerary.bodenstaendige, trendsetter: @itinerary.trendsetter, tueftler: @itinerary.tueftler }
    assert_redirected_to itinerary_path(assigns(:itinerary))
  end
